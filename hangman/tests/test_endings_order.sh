...
test_endings_order() {
  ...
  [[ $output == "Geschafft, aber mit vielen Fehlern. Übung macht den Meister." ]] && echo succes || echo failed 
  ...
  [[ $output == "Perfekt! 👍 Du hast das Wort ohne Fehler erraten." ]]  && echo succes || echo failed 
